...
// Seeding is a replace, not an append: re-running must not leave the previous
// graph behind. Runtime tables (agent keys, call log, approvals, outreach) are
...
const connectionRows: Array<[string, string, string, string | null, number, string]> = [
  [
    "gmail",
    "Gmail",
    "stale",
